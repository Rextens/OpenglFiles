...
public:
	...
	static int findUniform(GLuint shader_program, std::string uniform_name);
	static void setUniform(GLint uniform_handle, GLint value);
	static void setUniform(GLint uniform_handle, const glm::mat4 &matrix);
	static void setUniform(GLint uniform_handle, glm::vec3 &value);
};
