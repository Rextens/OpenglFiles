...
bool MouseAndKeyboard::oneKeyPressed(GLFWwindow *window, int key)
{
	if (keyBoard[key] == 0 && glfwGetKey(window, key))
	{
		keyBoard[key] = 1;
...
bool MouseAndKeyboard::oneButtonPressed(GLFWwindow *window, int key)
{
	if (buttonBoard[key] == 0 && glfwGetMouseButton(window, key))
	{
		buttonBoard[key] = 1;
...
bool MouseAndKeyboard::permaKeyPressed(GLFWwindow *window, int key)
{
...
bool MouseAndKeyboard::permaButtonPressed(GLFWwindow *window, int key)
{
...
void MouseAndKeyboard::closeWindow(GLFWwindow *window)
{
...
std::string MouseAndKeyboard::getKeybord(GLFWwindow *window)
{
	...
	else if (oneKeyPressed(window, GLFW_KEY_SPACE))
	{
		sentence.push_back(' ');
	}
...
int MouseAndKeyboard::getNumber(GLFWwindow *window)
{
	if (oneKeyPressed(window, GLFW_KEY_0))
	{
		numberSentence.push_back('0');
	}
	else if (oneKeyPressed(window, GLFW_KEY_1))
	{
		numberSentence.push_back('1');
	}
	else if (oneKeyPressed(window, GLFW_KEY_2))
	{
		numberSentence.push_back('2');
	}
	else if (oneKeyPressed(window, GLFW_KEY_3))
	{
		numberSentence.push_back('3');
	}
	else if (oneKeyPressed(window, GLFW_KEY_4))
	{
		numberSentence.push_back('4');
	}
	else if (oneKeyPressed(window, GLFW_KEY_5))
	{
		numberSentence.push_back('5');
	}
	else if (oneKeyPressed(window, GLFW_KEY_6))
	{
		numberSentence.push_back('6');
	}
	else if (oneKeyPressed(window, GLFW_KEY_7))
	{
		numberSentence.push_back('7');
	}
	else if (oneKeyPressed(window, GLFW_KEY_8))
	{
		numberSentence.push_back('8');
	}
	else if (oneKeyPressed(window, GLFW_KEY_9))
	{
		numberSentence.push_back('9');
	}
	else if (oneKeyPressed(window, GLFW_KEY_SPACE))
	{
		numberSentence.push_back(' ');
	}
	else if (oneKeyPressed(window, GLFW_KEY_BACKSPACE))
	{
		numberSentence.pop_back();
	}
	else if (oneKeyPressed(window, GLFW_KEY_MINUS))
	{
		numberSentence.push_back('-');
	}
	if (oneKeyPressed(window, GLFW_KEY_ENTER))
	{
		numberSentence2 = numberSentence;
		numberSentence = "";
		return atoi(numberSentence2.c_str());
	}
	else
	{
		return atoi(numberSentence2.c_str());
...
bool MouseAndKeyboard::mouseCollision(glm::vec3 &opposite, float &size)
{
	if (Auxiliary::getDistance(Window::camera_position + Window::camera_direction, opposite, size))
	{
		return true;
	}
}